use super::{compose_inline_tag, decompose_inline_tag, Guard, Pointable, PointerOrInline, Shared};
use std::fmt;
...
impl<T: Pointable> Inline<T> {
    pub fn new(data: usize) -> Self {
        ...
        Inline {
            data: compose_inline_tag::<T>((data << T::ALIGN.trailing_zeros()) as *mut (), 0)
                as *mut (),
            _marker: PhantomData,
        }
    }
