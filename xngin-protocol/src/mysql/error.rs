...
impl From<xngin_sql::error::Error> for Error {
    #[inline]
    fn from(src: xngin_sql::error::Error) -> Self {
        match src {
            xngin_sql::error::Error::SyntaxError(_) => Error::SyntaxError(),
        }
    }
}

impl From<xngin_plan::error::Error> for Error {
    #[inline]
    fn from(src: xngin_plan::error::Error) -> Self {
