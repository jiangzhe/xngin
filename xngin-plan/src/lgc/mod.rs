...
impl LgcPlan {
    ...
    #[inline]
    pub fn new<C: Catalog>(catalog: &C, default_schema: &str, query: &QueryExpr<'_>) -> Result<Self> {
...
pub(crate) mod tests {
    ...
    use xngin_catalog::{Catalog, ColumnAttr, ColumnSpec, TableID, TableSpec};
